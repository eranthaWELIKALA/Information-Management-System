...
<div class='col-md-3'>
  ...
  <!--<h2>Notifications</h2>
	  <div class="col-md-2"><a href="requests.php"><span class="glyphicon glyphicon-envelope"></span>unseen requests</a></div>
	  <div class="col-md-1">
		  <span class="badge">
			  <?php
			  $requests1_query="SELECT COUNT(*) FROM signup_requests WHERE Accepted=false";
	...
	<div class="col-md-2"><a href="requests.php"><span class="glyphicon glyphicon-envelope"></span>pending requests</a></div>
	<div class="col-md-1">
		  <span class="badge">
			  <?php
			  $requests2_query="SELECT COUNT(*) FROM signup_requests";
