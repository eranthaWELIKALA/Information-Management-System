				...
				echo '<div class="container" align="center">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<strong>Account for this Admission No , is already created.</strong></div><br>
							</div>
							<div class="col-md-3"></div>
						</div>
					</div>';
							...
							echo '<div class="container" align="center">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="alert alert-info alert-dismissable">
											<a href="signup.php" class="close" data-dismiss="alert" arial-label="close">&times</a>
											<strong>Your request was unsuccessful. Account for this Admission No , is already created.</strong></div><br>
										</div>
										<div class="col-md-3"></div>
									</div>
								</div>';
